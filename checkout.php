...
session_start();
    ...
    {
        echo "<script>location.href='https://eltscertification.in/landing/memplans.php';</script>";
    }
      ...
      <div class="col-md-12 col-lg-10 col-xl-8">
        <div class="card">
          <div class="card-body p-md-5">
            <div>
              <h4>Confirm Membership</h4>
              <p class="text-muted pb-2">
                Please make the payment to start enjoying all the features of our membership
            ...
            <div class="px-3 py-4 border border-primary border-2 rounded mt-4 d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                ...
                <div class="d-flex flex-column ms-4">
                  ...
                  <span class="small text-muted cursor-pointer"  onclick="location.href='memplans.php'">CHANGE PLAN</span>
                </div>
              </div>
          ...
          <button class="btn btn-outline-primary" type="button" id="button-addon2">Apply</button>
            ...
            <div class="mt-4">
              <button class="btn btn-primary btn-block btn-lg" id="submit-button" disabled>
