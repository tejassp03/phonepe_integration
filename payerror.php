      ...
      <div class="col-md-12 col-lg-10 col-xl-8">
          ...
          <div class="card-body p-md-5">
            <div>
              ...
              <p class="text-muted pb-2" id="statustext">
               Your payment has failed due to a technical error. Please try again to activate your ELTS Membership <br> Any payment that has already been deducted from your account will be automatically refunded.</p>
            </div>

            <div class="px-3 py-4 border border-danger border-2 rounded  d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="assets/img/memicon.png" class="rounded" width="60" />
                <div class="d-flex flex-column ms-4">
                  <span class="h5 mb-1"><?php echo $cardtype;?></span>
                  <span class="small text-danger" >PAYMENT FAILED</span>
                </div>
              </div>
        ...
        <dl class="row mt-2">
          ...
          <button class="btn btn-outline-primary" type="button" id="button-addon2">Apply</button>
            ...
            <div class="mt-4">
              <button class="btn btn-primary btn-block btn-lg"  onclick="location.href='checkout.php?memtype=1000'">
                Try Again</i>
              </button>
            </div>
          </div>
