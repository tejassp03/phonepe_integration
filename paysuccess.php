    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-12 col-lg-10 col-xl-8">
          ...
          <div class="card-body p-md-5">
            <div>
              ...
              <p class="text-muted pb-2" id="statustext">
               Your ELTS Membership has been successfully activated. Start Practicing by clicking on the button given below.</p>
            </div>

            <div class="px-3 py-4 border border-success border-2 rounded  d-flex justify-content-between">
              <div class="d-flex flex-row align-items-center">
                <img src="assets/img/memicon.png" class="rounded" width="60" />
                <div class="d-flex flex-column ms-4">
                  <span class="h5 mb-1"><?php echo $cardtype;?></span>
                  <span class="small text-success" >ACTIVATED</span>
                </div>
              </div>
        ...
        <dl class="row mt-2">
          ...
          <dd class="col-sm-9"><?php echo $transid; ?></dd>

          <dt class="col-sm-3">Membership</dt>
          <dd class="col-sm-9"><?php echo $memtype; ?></dd>

          <dt class="col-sm-3">Amount</dt>
          <dd class="col-sm-9"><?php echo $memamt; ?></dd>
          ...
          <button class="btn btn-outline-primary" type="button" id="button-addon2">Apply</button>
            ...
            <div class="mt-4">
              <button class="btn btn-primary btn-block btn-lg" id="submit-button" >
                Start Practicing &nbsp;<i class='bx bxs-rocket'></i>
              </button>
            </div>
          </div>
        </div>
